""" Recupera dati da API-Football e genera docs/data.json per la dashboard. Eseguito automaticamente da GitHub Actions. La chiave API viene letta dalla variabile d'ambiente API_FOOTBALL_KEY (configurata come GitHub Secret, mai scritta nel codice). Budget richieste: il piano gratuito consente 100 chiamate/giorno. Lo script è calibrato per restare sotto quel limite. """
