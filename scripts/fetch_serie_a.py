...
def calcola_statistiche(righe, future):
    ...
    lista_squadre = sorted([
        {"nome": nome, "partite": s["partite"], "gialli": s["gialli"], "rossi": s["rossi"],
         ...
         "mediaTiri": media(s["tiri"], s["conDati"], 1),
         "mediaCorner": media(s["corner"], s["conDati"], 1),
    ...
    for r in righe[-40:]:
        ultime.append({
            ...
            "tiriCasa": num(r, "TiriCasa"), "tiriOspite": num(r, "TiriOspite"),
            "cornerCasa": num(r, "CornerCasa"), "cornerOspite": num(r, "CornerOspite"),
        })
    ultime.reverse()
